            ...
            <tbody>
              {tick.map((ticketsito, index) => (
                <tr key={index} className="ticket-body">
                  ...
                  <td> <button className="ticket-button-reabrir" onClick={() => openModal3(ticketsito)}>Reabrir</button></td>
      ...
      {showModal2 && (
        <div className="modal">
          <div className="modal-content">
            ...
            <p id='titulin2'>Historial del ticket 🏷️</p>
            ...
            {Array.isArray(userData) &&
              userData.map((user, index) => (
                <tr key={index} className="ticket-body">
                  ...
                  <td><button id="reasignar-btn" onClick={() => Reasignar(selectedTicket.folio, user)}>Reasignar</button></td>
                </tr>
              ))}
