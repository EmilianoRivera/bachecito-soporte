    ...
    <div className="modal-content">
      ...
      {selectedTicket2.estado === "Sin asignar" && (
        <div className='datos-sinasignar'>
          ...
          <button className="ticket-button" onClick={() => openModal3(selectedTicket2)}>Gestionar</button>
        </div>
      )}
          ...
          <div className="modal-content">
            ...
            userData.map((user, index) => (
              <tr key={index} className="ticket-body">
                ...
                <td>
    <button onClick={() => Asignar(selectedTicket.folio, user, selectedTicket)}>Asignar</button>
</td>
              </tr>
            ))}
